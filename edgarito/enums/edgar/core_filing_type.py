...
class CoreFilingType(Enum):
    ...
    def is_annual_report(cls, form: str) -> bool:
        ...
        return form in (
            cls.FILING_10K.value,
            cls.FILING_10K_AMEND.value,
            cls.FILING_20F.value,
        )
    ...
    def is_quarterly_report(cls, form: str) -> bool:
        ...
        return form in (
            cls.FILING_10Q.value,
            cls.FILING_10Q_AMEND.value,
            cls.FILING_6K.value,
        )
    ...
    def is_insider_filing(cls, form: str) -> bool:
        ...
        return form in (
            ...
            cls.FILING_4.value,
            cls.FILING_5.value,
            cls.FILING_SC13D.value,
            cls.FILING_SC13G.value,
        )
